;jQuery(document).ready(function ($) {
    ...
    $('.bitbucket-widget').each(function () {
    ...
    if (vendors) {
        $('head').append(
            '<style type="text/css">'
            + '.bitbucket-box *{-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;}'
            + '.bitbucket-box{font-family:helvetica,arial,sans-serif;font-size:13px;line-height:18px;background:#fafafa;border:1px solid #ddd;color:#666;border-radius:3px}'
            + '.bitbucket-box a{color:#4183c4;border:0;text-decoration:none}'
            + '.bitbucket-box .bitbucket-box-title{position:relative;border-bottom:1px solid #ddd;border-radius:3px 3px 0 0;background:#fcfcfc;background:-moz-linear-gradient(#fcfcfc,#ebebeb);background:-webkit-linear-gradient(#fcfcfc,#ebebeb);}'
            + '.bitbucket-box .bitbucket-box-title h3{word-wrap:break-word;font-family:helvetica,arial,sans-serif;font-weight:normal;font-size:16px;color:gray;margin:0;padding:10px 10px 10px 30px;background:url(' + box_title_png + ') 7px center no-repeat; width: auto;}'
            + '.bitbucket-box .bitbucket-box-title h3 .repo{font-weight:bold}'
            + '.bitbucket-box .bitbucket-box-title .bitbucket-stats{float:right;position:absolute;top:8px;right:10px;font-size:11px;font-weight:bold;line-height:21px;height:auto;min-height:21px}'
            + '.bitbucket-box .bitbucket-box-title .bitbucket-stats a{display:inline-block;height:21px;color:#666;border:1px solid #ddd;border-radius:3px;padding:0 5px 0 18px;background: white url(' + stats_png + ') no-repeat}'
            + '.bitbucket-box .bitbucket-box-title .bitbucket-stats .watchers{border-right:1px solid #ddd}'
            + '.bitbucket-box .bitbucket-box-title .bitbucket-stats .forks{background-position:-4px -21px;padding-left:15px}'
            + '.bitbucket-box .bitbucket-box-content{padding:10px;font-weight:300}'
            + '.bitbucket-box .bitbucket-box-content p{margin:0}'
            + '.bitbucket-box .bitbucket-box-content .link{font-weight:bold}'
            + '.bitbucket-box .bitbucket-box-download{position:relative;border-top:1px solid #ddd;background:white;border-radius:0 0 3px 3px;padding:10px;height:auto;min-height:24px;}'
            + '.bitbucket-box .bitbucket-box-download .updated{word-wrap:break-word;margin:0;font-size:11px;color:#666;line-height:24px;font-weight:300;width:auto}'
            + '.bitbucket-box .bitbucket-box-download .updated strong{font-weight:bold;color:#000}'
            + '.bitbucket-box .bitbucket-box-download .download{float:right;position:absolute;top:10px;right:10px;height:24px;line-height:24px;font-size:12px;color:#666;font-weight:bold;text-shadow:0 1px 0 rgba(255,255,255,0.9);padding:0 10px;border:1px solid #ddd;border-bottom-color:#bbb;border-radius:3px;background:#f5f5f5;background:-moz-linear-gradient(#f5f5f5,#e5e5e5);background:-webkit-linear-gradient(#f5f5f5,#e5e5e5);}'
            + '.bitbucket-box .bitbucket-box-download .download:hover{color:#527894;border-color:#cfe3ed;border-bottom-color:#9fc7db;background:#f1f7fa;background:-moz-linear-gradient(#f1f7fa,#dbeaf1);background:-webkit-linear-gradient(#f1f7fa,#dbeaf1);}'
            + '@media (max-width: 767px) {'
            + '.bitbucket-box .bitbucket-box-title{height:auto;min-height:60px}'
            + '.bitbucket-box .bitbucket-box-title h3 .repo{display:block}'
            + '.bitbucket-box .bitbucket-box-title .bitbucket-stats a{display:block;clear:right;float:right;}'
            + '.bitbucket-box .bitbucket-box-download{height:auto;min-height:46px;}'
            + '.bitbucket-box .bitbucket-box-download .download{top:32px;}'
            + '}'
            + '</style>'
        );
